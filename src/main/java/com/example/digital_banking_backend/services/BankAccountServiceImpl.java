...
public class BankAccountServiceImpl implements BankAccountService{
    ...
    private BankAccountMapperImpl dtopMapper;
    @Override
    public CustomerDTO saveCustomer(CustomerDTO customerDTO) {
        log.info("Saving New Customer");
        Customer customer = dtopMapper.fromCustomerDTO(customerDTO);
        Customer savedCustomer = customerRepository.save(customer);
        return dtopMapper.fromCustomer(savedCustomer);
    }
    ...
    public CurrentBankAccountDTO saveCurrentBankAccount(double initialBalance, double overDraft, Long customerId) throws CustomerNotFoundException {
        ...
        return dtopMapper.fromCurrentBankAccount(savedBankAccount);
    }
    ...
    public SavingBankAccountDTO saveSavingBankAccount(double initialBalance, double interestRate, Long customerId) throws CustomerNotFoundException {
        ...
        return dtopMapper.fromSavingBankAccount(SavedSavingAccount);
    }
    ...
    public List<CustomerDTO> listCustomers() {
        ...
        List<CustomerDTO> collect =  customers.stream().map(customer-> dtopMapper.fromCustomer(customer)).collect(Collectors.toList());
        return collect;
    }
    ...
    public BankAccountDTO getBankAccount(String accountId) throws BankAccountNotFoundException {
        ...
        if(bankAccount instanceof SavingAccount){
            ...
            return dtopMapper.fromSavingBankAccount(SavingAccount);
        }else{
            CurrentAccount currentAccount  = (CurrentAccount) bankAccount;
            return dtopMapper.fromCurrentBankAccount(currentAccount);
        }
    }
    ...
    public CustomerDTO getCustomer(Long customerId) throws CustomerNotFoundException {
        ...
        return dtopMapper.fromCustomer(customer);
    }
    ...
    public List<AccountOperationDTO> accountHistory(String accountId){
        ...
        return accountOperations.stream().map(op-> dtopMapper.fromAccountOperation(op)).collect(Collectors.toList());
    }
    ...
    public AccountHistoryDTO getAccountHistory(String accountId, int page, int size) throws BankAccountNotFoundException {
        ...
        if(bankAccount == null){
         ...
         List<AccountOperationDTO> accountOperationDTOS = accountOperations.getContent().stream().map(op-> dtopMapper.fromAccountOperation(op)).collect(Collectors.toList());
